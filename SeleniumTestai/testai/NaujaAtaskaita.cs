...
namespace SeleniumTestai.testai
{
    public class NaujaAtaskaita
    {
        ...
        public void NaujaAtaskaitaTestas()
        {
            try
            {
                using (IWebDriver driver = new ChromeDriver())
                {
                    ...
                    driver.FindElement(By.XPath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div/div/div[2]/input")).SendKeys("Testine ataskaita");
                    // Priskiriami 2 kriterijai
                    for (int i = 0; i < 2; i++)
                    {
                        funkcijos.comboBoxSelection(driver, "//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[1]/div[1]/div[2]/div/div/div[2]/i", 1);
                        driver.FindElement(By.XPath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[1]/div[2]/div[2]/button")).Click();
                        Thread.Sleep(1000); 
                    }
                    Console.WriteLine("\nKriterijai prideti sekmingai!");
                    ...
                    Console.WriteLine("\nKriterijai istrinti sekmingai!");

                    // Pazymeti įtraukti
                    funkcijos.comboBoxSelection(driver, "//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[2]/div/div[2]/div/div/div[2]/i", 2);
                    ...
                    for (int i = 0; i < 4; i++)
                    {
                        funkcijos.comboBoxSelection(driver, "//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[3]/div/div[1]/div/div[2]/div/div", i + 1);
                        Thread.Sleep(1000);
                        for(int j = 0; j < 4; j++)
                        {
                            funkcijos.comboBoxSelection(driver, "//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[3]/div/div[2]/div[1]/div[2]/div/div/div[2]/i", 1);
