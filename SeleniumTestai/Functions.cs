...
namespace SeleniumTestai
{
    ...
    {
        public void comboBoxSelection(IWebDriver driver, string xpath, int arrowCount)
        {
        ...
        public void LoginToOrangeHRM(IWebDriver driver, string url, string username, string password)
        {
        ...
        public void ExecuteTestIfUserExists(string? userURL, Action<string> testAction)
        {
            ...
            else
            {
                ...
                Console.WriteLine("\nDarbuotojas dar nėra sukurtas. Pirmiausiai sukurti darbuotoją.");
